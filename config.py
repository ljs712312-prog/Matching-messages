...
LOOKUP_PAGE_TIMEOUT_MS = _as_int(os.getenv("LOOKUP_PAGE_TIMEOUT_MS"), 45_000)
LOOKUP_SELECTOR_TIMEOUT_MS = _as_int(os.getenv("LOOKUP_SELECTOR_TIMEOUT_MS"), 30_000)
LOOKUP_RESULT_WAIT_SECONDS = _as_int(os.getenv("LOOKUP_RESULT_WAIT_SECONDS"), 45)
LOOKUP_VILLA_RESULT_WAIT_SECONDS = _as_int(os.getenv("LOOKUP_VILLA_RESULT_WAIT_SECONDS"), 75)
