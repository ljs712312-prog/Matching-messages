...
LOOKUP_DELAY_MIN = _as_float(os.getenv("LOOKUP_DELAY_MIN"), 0.15)
LOOKUP_DELAY_MAX = _as_float(os.getenv("LOOKUP_DELAY_MAX"), 0.45)
...
LOOKUP_VILLA_CANDIDATE_WAIT_SECONDS = _as_float(os.getenv("LOOKUP_VILLA_CANDIDATE_WAIT_SECONDS"), 8.0)
